/**
 * sinhala-unicode-converter v1.0.2 (browser bundle)
 * Converts legacy Sinhala font encodings to Unicode.
 * Source: https://github.com/Open-SL/sinhala-unicode-converter
 * License: MIT
 */
(function(global) {
global.fmAbayaToUnicode = function (text) {
...
global.dlManelToUnicode = function (text) {
    text = text.replace(/\'/g, "♥");
...
global.kaputaToUnicode = function (text) {
...
global.baminiToUnicode = function (text) {
...
global.amaleeToUnicode = function (text) {
    text = text.replace(/\&/g, ")");
    text = text.replace(/ff;%/g, "ත්‍රෛ");
    text = text.replace(/ffY/g, "ශෛ");
    text = text.replace(/ffp/g, "චෛ");
...
global.thibusToUnicode = function (text) {
