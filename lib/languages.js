...
(function (root, factory) {
    ...
    const LANGUAGES = {
        ...
        en: {
            ...
            font: 'inherit', family: null,
            script: /[A-Za-z]/, rtl: false, tuned: true,
            examples: [
        ...
        ta: {
            ...
            script: /[஀-௿]/, rtl: false, tuned: false, examples: [],
        },
        hi: {
            name: 'Hindi', nativeName: 'हिन्दी',
            font: "'Noto Sans Devanagari', sans-serif", family: 'Noto+Sans+Devanagari:wght@400;600;800',
            script: /[ऀ-ॿ]/, rtl: false, tuned: false, examples: [],
        },
        ar: {
            name: 'Arabic', nativeName: 'العربية',
            font: "'Noto Sans Arabic', sans-serif", family: 'Noto+Sans+Arabic:wght@400;600;800',
            script: /[؀-ۿݐ-ݿ]/, rtl: true, tuned: false, examples: [],
        },
        zh: {
            name: 'Chinese (Simplified)', nativeName: '简体中文',
            font: "'Noto Sans SC', sans-serif", family: 'Noto+Sans+SC:wght@400;600;800',
            script: /[一-鿿]/, rtl: false, tuned: false, examples: [],
        },
        ja: {
            name: 'Japanese', nativeName: '日本語',
            font: "'Noto Sans JP', sans-serif", family: 'Noto+Sans+JP:wght@400;600;800',
            script: /[぀-ヿ一-鿿]/, rtl: false, tuned: false, examples: [],
        },
        ko: {
            name: 'Korean', nativeName: '한국어',
            font: "'Noto Sans KR', sans-serif", family: 'Noto+Sans+KR:wght@400;600;800',
            script: /[가-힯ᄀ-ᇿ]/, rtl: false, tuned: false, examples: [],
        },
        // Inter already ships Latin and Cyrillic, so these load no extra font.
        es: { name: 'Spanish',    nativeName: 'Español',   font: 'inherit', family: null, script: /[A-Za-z]/, rtl: false, tuned: false, examples: [] },
        fr: { name: 'French',     nativeName: 'Français',  font: 'inherit', family: null, script: /[A-Za-z]/, rtl: false, tuned: false, examples: [] },
        pt: { name: 'Portuguese', nativeName: 'Português', font: 'inherit', family: null, script: /[A-Za-z]/, rtl: false, tuned: false, examples: [] },
        de: { name: 'German',     nativeName: 'Deutsch',   font: 'inherit', family: null, script: /[A-Za-z]/, rtl: false, tuned: false, examples: [] },
        ru: { name: 'Russian',    nativeName: 'Русский',   font: 'inherit', family: null, script: /[Ѐ-ӿ]/, rtl: false, tuned: false, examples: [] },
    };
    ...
    return { LANGUAGES, DEFAULT_LANG, getLang, listLangs, examplesBlock, detectDefault, isScript };
});
