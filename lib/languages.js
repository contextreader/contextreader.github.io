...
(function (root, factory) {
    ...
    const TYPESETS = {
        ...
        armenian:   { font: "'Noto Sans Armenian', sans-serif", family: 'Noto+Sans+Armenian:wght@400;600;800', script: /\p{Script=Armenian}/u, rtl: false },
        georgian:   { font: "'Noto Sans Georgian', sans-serif", family: 'Noto+Sans+Georgian:wght@400;600;800', script: /\p{Script=Georgian}/u, rtl: false },
        hebrew:     { font: "'Noto Sans Hebrew', sans-serif", family: 'Noto+Sans+Hebrew:wght@400;600;800', script: /\p{Script=Hebrew}/u, rtl: true },
        thaana:     { font: "'Noto Sans Thaana', sans-serif", family: 'Noto+Sans+Thaana:wght@400;600;800', script: /\p{Script=Thaana}/u, rtl: true },
        ethiopic:   { font: "'Noto Sans Ethiopic', sans-serif", family: 'Noto+Sans+Ethiopic:wght@400;600;800', script: /\p{Script=Ethiopic}/u, rtl: false },
        bengali:    { font: "'Noto Sans Bengali', sans-serif", family: 'Noto+Sans+Bengali:wght@400;600;800', script: /\p{Script=Bengali}/u, rtl: false },
        gujarati:   { font: "'Noto Sans Gujarati', sans-serif", family: 'Noto+Sans+Gujarati:wght@400;600;800', script: /\p{Script=Gujarati}/u, rtl: false },
        gurmukhi:   { font: "'Noto Sans Gurmukhi', sans-serif", family: 'Noto+Sans+Gurmukhi:wght@400;600;800', script: /\p{Script=Gurmukhi}/u, rtl: false },
        oriya:      { font: "'Noto Sans Oriya', sans-serif", family: 'Noto+Sans+Oriya:wght@400;600;800', script: /\p{Script=Oriya}/u, rtl: false },
        telugu:     { font: "'Noto Sans Telugu', sans-serif", family: 'Noto+Sans+Telugu:wght@400;600;800', script: /\p{Script=Telugu}/u, rtl: false },
        kannada:    { font: "'Noto Sans Kannada', sans-serif", family: 'Noto+Sans+Kannada:wght@400;600;800', script: /\p{Script=Kannada}/u, rtl: false },
        malayalam:  { font: "'Noto Sans Malayalam', sans-serif", family: 'Noto+Sans+Malayalam:wght@400;600;800', script: /\p{Script=Malayalam}/u, rtl: false },
        thai:       { font: "'Noto Sans Thai', sans-serif", family: 'Noto+Sans+Thai:wght@400;600;800', script: /\p{Script=Thai}/u, rtl: false },
        lao:        { font: "'Noto Sans Lao', sans-serif", family: 'Noto+Sans+Lao:wght@400;600;800', script: /\p{Script=Lao}/u, rtl: false },
        khmer:      { font: "'Noto Sans Khmer', sans-serif", family: 'Noto+Sans+Khmer:wght@400;600;800', script: /\p{Script=Khmer}/u, rtl: false },
        myanmar:    { font: "'Noto Sans Myanmar', sans-serif", family: 'Noto+Sans+Myanmar:wght@400;600;800', script: /\p{Script=Myanmar}/u, rtl: false },
        meetei:     { font: "'Noto Sans Meetei Mayek', sans-serif", family: 'Noto+Sans+Meetei+Mayek:wght@400;600;800', script: /\p{Script=Meetei_Mayek}/u, rtl: false },
    };
